...
from datatypes import ManagerElement, LayoutSchema, ElementsDict
...
class LayoutManager(object):
    ...
    def centre_elements(self, elements: List[ManagerElement]) -> None:
    ...
    def set_layout(
        self, layout_schema: LayoutSchema, elements_dict: ElementsDict
    ) -> None:
    ...
    @staticmethod
    def _return_max_row_length(input_list: List[Union[list, None]]):
        max_length = 0
